    ...
    t_onFuncLoad('t396_elem__getFieldValue', function () {
      t_zeroGallery__processGalleryWithGeoLanding(l, function () {
        t_zeroGallery__render(
          (r = l.querySelector('.tn-elem[data-elem-id="' + t + '"]'))
        ),
      ...
      'y' !== r.getAttribute('data-field-zoomable-value') ||
      ...
      window.addEventListener('resize', function () {
        t396_waitForFinalEvent(
          ...
          500,
          'slds_resizeruniqueid' + e + t
        );
      });
    var s = l.querySelector('.t396');
    s &&
      ('undefined' != typeof jQuery
        ? ($(s).unbind('displayChanged', t_zeroGallery__updateSliderHandler),
...
function t_zeroGallery__render(e) {
  ...
  for (
    ...
    var y = a[c],
      ...
      u;
    if (
      ((y.li_youtube || y.li_vimeo || y.li_imgurl) && (d = !0),
      (_ = _ && !y.li_imgurl),
      y.li_vimeo || y.li_youtube)
    ) {
      if (
        (y.li_youtube
          ? ((u = y.li_youtube) || (u = ''), (m = ''))
      ...
      var p =
        ...
        (y.li_imgurl ? 'a href="' + y.li_imgurl + '"' : 'div') +
        ' data-img-lid="' +
        y.lid +
        '" ' +
        (y.li_imgtarget ? 'target="_bl"' : '') +
        (y.li_imgnofollow ? 'rel="nofollow"' : '') +
        (_
          ? ' data-zoom-target="' +
            (c + 1) +
    ...
    var f = e.querySelectorAll('.t-slds');
    !(function (e, t) {
      Array.prototype.forEach.call(f, function (l) {
        var r =
          '<div class="t-slds__caption' +
          (0 === e ? ' t-slds__caption-active' : '') +
          '" data-slide-caption="' +
          (e + 1) +
...
function t_zeroGallery__renderViewOneField(e, t, l) {
  ...
  switch ((void 0 === a && (a = ''), l)) {
    case 'slds_imgposition':
      ...
      a || (a = 'center center'),
        t_zeroGallery__removeElement(
          e.querySelector('.tn-elem__gallery__position-styles')
        ),
        s &&
          ((b = document.createElement('style')).classList.add(
    ...
    case 'slds_stretch':
      ...
      a || (a = 'cover'),
        t_zeroGallery__removeElement(
          e.querySelector('.tn-elem__gallery__stretch-styles')
        ),
        s &&
          ((b = document.createElement('style')).classList.add(
    ...
    case 'slds_arrowcontrols':
      if (
        ...
        var z = t396_elem__getFieldValue(
          r ? $(e) : e,
          'slds_arrowbetweenmargin'
        );
        z || (z = '10'),
    ...
    case 'slds_dotshmargin':
      ...
      a || (a = '20'),
        t_zeroGallery__removeElement(
          e.querySelector('.tn-elem__gallery__bullet-hmargin-styles')
        ),
        s &&
          ((b = document.createElement('style')).classList.add(
    ...
    case 'slds_dotscontrols':
      a || (a = 'none'),
        ...
        (v = parseInt(
          t396_elem__getFieldValue(r ? $(e) : e, 'slds_dotssize'),
          10
        )),
    ...
    case 'slds_playiconsize':
      ...
      a || (a = '70'),
        t_zeroGallery__removeElement(
          e.querySelector('.tn-elem__gallery__icon-size-styles')
        ),
        s &&
          ((b = document.createElement('style')).classList.add(
    ...
    case 'slds_playiconcolor':
      ...
      a || (a = '#fff'),
        t_zeroGallery__removeElement(
          e.querySelector('.tn-elem__gallery__icon-color-styles')
        ),
        s &&
          ((b = document.createElement('style')).classList.add(
    ...
    case 'slds_arrowborder':
      ...
      if (
        (a || (a = 'none'),
        t_zeroGallery__removeElement(
          e.querySelector('.tn-elem__gallery__arrow-border-styles')
        ),
        'none' !== a)
      ) {
        var F =
            t396_elem__getFieldValue(r ? $(e) : e, 'slds_arrowlinesize') || '1',
          x =
            t396_elem__getFieldValue(r ? $(e) : e, 'slds_arrowcolor') || '#222',
          V =
            t396_elem__getFieldValue(r ? $(e) : e, 'slds_arrowcolorhover') || x;
        s &&
          ((b = document.createElement('style')).classList.add(
    ...
    case 'slds_dotsbgcoloractive':
      ...
      if (
        ...
        (w = -1 !== a.indexOf('-gradient(')),
        t_zeroGallery__removeElement(
          e.querySelector('.t-slds__bullet_wrapper style')
        ),
        i)
      ) {
    ...
    case 'slds_arrowbgcolor':
      var B = t_zeroGallery__getArrowSize(
          (m = t396_elem__getFieldValue(r ? $(e) : e, 'slds_arrowsize'))
        ),
        ...
        a
          ? ((e.style.width = B + 'px'),
            ...
            (e.style.backgroundColor = T
              ? 'rgba(' + t_zeroGallery__hex2rgba(a, T) + ')'
              : a))
          : ((e.style.width = B + 'px'),
            (e.style.height = B + 'px'),
    ...
    case 'slds_dotssize':
      a || (a = '10'),
        Array.prototype.forEach.call(y, function (e) {
          (e.style.width = a + 'px'), (e.style.height = a + 'px');
        }),
    ...
    case 'slds_loop':
      a || (a = 'loop'),
        'none' === a &&
          (_ && _.setAttribute('data-slider-with-cycle', 'false'),
          o && o.classList.add('t-slds__nocycle')),
        'loop' === a &&
          (_ && _.setAttribute('data-slider-with-cycle', 'true'),
      ...
      t_zeroGallery__renderViewOneField(e, t, 'slds_arrowborder'),
        Array.prototype.forEach.call(d, function (t) {
          ...
          t.addEventListener('mouseenter', function () {
            a ||
              (a = t396_elem__getFieldValue(
                r ? $(e) : e,
                'slds_arrowcolorhover'
              )),
              a ||
                (a = t396_elem__getFieldValue(r ? $(e) : e, 'slds_arrowcolor')),
              a || (a = '#222'),
    ...
    case 'slds_arrowbgcolorhover':
      Array.prototype.forEach.call(d, function (t) {
        t.addEventListener('mouseenter', function () {
          var l = t396_elem__getFieldValue(
            r ? $(e) : e,
            'slds_arrowbgopacityhover'
          );
          l || (l = '1.0'),
            a ||
              (a = t396_elem__getFieldValue(r ? $(e) : e, 'slds_arrowbgcolor')),
            a || (a = 'transparent');
          var s = a;
          'transparent' !== a &&
            (s = 'rgba(' + t_zeroGallery__hex2rgba(a, l) + ')'),
            (t.style.backgroundColor = s);
        }),
          t.addEventListener('mouseleave', function () {
            var l = t396_elem__getFieldValue(r ? $(e) : e, 'slds_arrowbgcolor');
            if ((l || (l = 'transparent'), 'transparent' !== l)) {
              var a = t396_elem__getFieldValue(
                r ? $(e) : e,
                'slds_arrowbgopacity'
              );
              a || (a = '1.0'),
    ...
    case 'slds_dotsvmargin':
      a || (a = '16'),
        (g = t396_elem__getFieldValue(r ? $(e) : e, 'slds_dotscontrols')),
        i &&
          ('near' === g
            ? ((i.style.marginBottom = -a + 'px'),
    ...
    case 'slds_captiontopmargin':
      ...
      if (
        ('near' === g &&
          ((p = t396_elem__getFieldValue(r ? $(e) : e, 'slds_dotsvmargin')) ||
            (p = '16'),
          (v = t396_elem__getFieldValue(r ? $(e) : e, 'slds_dotssize')) ||
            (v = '10'),
          (Q = 20 + parseInt(v, 10) + parseInt(p, 10))),
        'under' === u)
      ) {
    ...
    case 'slds_captionwidth':
      ...
      a || (a = '80'),
        t_zeroGallery__removeElement(
          e.querySelector('.tn-elem__gallery__caption-width-styles')
        ),
        s &&
          ((b = document.createElement('style')).classList.add(
    ...
    case 'slds_arrowvmargin':
      ...
      if (
        ...
        'near' ===
          ...
          ((p = t396_elem__getFieldValue(r ? $(e) : e, 'slds_dotsvmargin')),
          (v = t396_elem__getFieldValue(r ? $(e) : e, 'slds_dotssize')),
          (R = 20 + parseInt(v, 10) + parseInt(p, 10))),
          (a = parseInt(a, 10) + R),
          (U.bottom = -a + 'px'),
          (U.top = 'auto'),
          Array.prototype.forEach.call(d, function (e) {
      ...
      o && ((o.style.top = U.top), (o.style.bottom = U.bottom)),
        t_zeroGallery__renderViewOneField(e, t, 'slds_captiontopmargin');
      break;
...
function t_zeroGallery__playVideo() {
  ...
  if (
    (t && (t.style.opacity = '0'),
    !(
      (e && !e.classList.contains('tn-elem__gallery__frame')) ||
      (e && e.querySelector('.tn-elem__gallery__iframe'))
    ))
  ) {
