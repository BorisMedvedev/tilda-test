...
(window.browserLang = (
        ...
        for (var r = 0; r < o.length; r++)
          -1 !== o[r].nodeValue.indexOf("'t remove this l") &&
            document
              ...
              .insertAdjacentHTML(
                'afterend',
                '<div class="t-tildalabel t-tildalabel-free" style="display: block !important; visibility: visible !important; position: relative !important; width: 100% !important; pointer-events: all !important; opacity: 1 !important; margin: 0 !important; z-index: 99900 !important"><div class="t-tildalabel-free__main"><a href="https://tilda.cc" target="_bl" style="padding-bottom:12px; display: block;"><img style="width:40px;" src="https://static.tildacdn.com/img/tildacopy.png"></a><div style="padding-bottom: 15px;">This site was made on <a href="https://tilda.cc" target="_bl" style="text-decoration: none; color:inherit;">Tilda — a website builder</a> that helps to&nbsp;create a&nbsp;website without any code</div><a href="https://tilda.cc/registration/" target="_bl" style="display: inline-block; padding: 10px 20px; font-size: 13px; border-radius: 50px; background-color: #fa8669; color: #fff; text-decoration: none;">Create a website</a></div><div class="t-tildalabel-free__links-wr"><a class="t-tildalabel-free__txt-link" href="https://help' +
                  ('RU' === window.browserLang ? '-ru' : '') +
                  '.tilda.cc/white-label" target="_bl">' +
  ...
  t_onReady(function () {
    ...
    var w = document.querySelector('.t-tildalabel'),
      f;
    (f = p
      ? Math.max(p.scrollHeight, p.offsetHeight, p.clientHeight, m.offsetHeight)
      : m.offsetHeight) +
      70 <
    window.innerHeight
    ...
    function e() {
      ...
      for (var n = 0; n < h.length; n++) {
        ...
        (o = (i = h[n]).style).height.indexOf('vh') > -1 &&
          ((e = parseInt(o.height) / 100), (d = m + 'px'), (o.height = d));
      }
    }
    function n() {
  ...
  t_onReady(function () {
    setTimeout(function () {
      for (
        var t = document.querySelectorAll('a[href^="http"][target="_bl"]'),
          e = 0;
        e < t.length;
        e++
      ) {
