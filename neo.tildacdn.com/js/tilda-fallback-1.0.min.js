...
/*************  ✨ Codeium Command ⭐  *************/
/**
 * Normalizes the current URL by removing any occurrences of
 * '/index.html' or '/default.html' from the pathname. If any
 * changes are made, it updates the browser's history state
 * with the new path while preserving search parameters.
 */

/******  6d5e5dc5-625b-4def-b118-f8beac7b61bc  *******/
function normalizeURL() {
  ...
  const cleanPatterns = [/^\/index\.html/, /^\/default\.html/];
  ...
  // Обновляем URL, если есть изменения
  if (newPath !== currentPath) {
    history.replaceState(null, document.title, newPath + searchParams);
  }
}

// Навешиваем обработчик
window.addEventListener('load', normalizeURL);
